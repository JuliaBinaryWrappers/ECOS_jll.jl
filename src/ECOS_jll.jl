...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ECOS_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c2c64177-6a8e-5dca-99a7-64895ad7445f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ECOS", artifacts_toml) for e in artifacts["ECOS"]]
...
if best_platform === nothing
    @debug("Unable to load ECOS; unsupported platform $(triplet(platform_key_abi()))")
else
